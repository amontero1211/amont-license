...
STATE = [("active", "Active"), ("expired", "Expired")]
...
class ServerClient(models.Model):
    ...
    reminder_30_days_sent = fields.Boolean("30 Days Reminder Sent", default=False)
    reminder_15_days_sent = fields.Boolean("15 Days Reminder Sent", default=False)
    reminder_7_days_sent = fields.Boolean("7 Days Reminder Sent", default=False)
    reminder_3_days_sent = fields.Boolean("3 Days Reminder Sent", default=False)
    reminder_1_day_sent = fields.Boolean("1 Day Reminder Sent", default=False)
    reminder_expired_sent = fields.Boolean("Expired Reminder Sent", default=False)
    ...
    def generate_license(self):
        ...
        self.license = "-".join(
            [hash_license[i : i + 5] for i in range(0, 25, 5)]
        ).upper()
    ...
    def _send_license_expired_email(self, partner_id):
        ...
        template = self.env.ref("amont_license_server.mail_template_license_expired")
